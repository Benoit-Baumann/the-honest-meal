class Review < ApplicationRecord
  ...
  validates :username, uniqueness: { case_sensitive: false }, presence: true, unless: :user_id?, on: :update #Username requis si user_id absent (user non connecté ou ne possédant pas de compte)
